...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Sun Dec 6 16:51:41 2015
# Project:  PIS.pro
# Template: app
...
$(TARGET): ui_mainwindow.h ui_formstationset.h ui_formsysstatus.h ui_formmenu.h ui_formaudio.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/PIS1.0.0/ && $(COPY_FILE) --parents mainwindow.h formstationset.h formsysstatus.h formmenu.h formaudio.h message.h rha.h .tmp/PIS1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp formstationset.cpp formsysstatus.cpp formmenu.cpp formaudio.cpp message.cpp .tmp/PIS1.0.0/ && $(COPY_FILE) --parents mainwindow.ui formstationset.ui formsysstatus.ui formmenu.ui formaudio.ui .tmp/PIS1.0.0/ && (cd `dirname .tmp/PIS1.0.0` && $(TAR) PIS1.0.0.tar PIS1.0.0 && $(COMPRESS) PIS1.0.0.tar) && $(MOVE) `dirname .tmp/PIS1.0.0`/PIS1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PIS1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_formstationset.cpp moc_formsysstatus.cpp moc_formmenu.cpp moc_formaudio.cpp moc_message.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_formstationset.cpp moc_formsysstatus.cpp moc_formmenu.cpp moc_formaudio.cpp moc_message.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_formstationset.h ui_formsysstatus.h ui_formmenu.h ui_formaudio.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_formstationset.h ui_formsysstatus.h ui_formmenu.h ui_formaudio.h
